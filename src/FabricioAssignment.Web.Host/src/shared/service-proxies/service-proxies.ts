...
export class ContentServiceProxy {
     ...
     * @return Success
     */
    getListAsync(): Observable<ListResultDtoOfContentListDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ListResultDtoOfContentListDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<ListResultDtoOfContentListDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetListAsync(response: HttpResponseBase): Observable<ListResultDtoOfContentListDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? ListResultDtoOfContentListDto.fromJS(resultData200) : new ListResultDtoOfContentListDto();
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ListResultDtoOfContentListDto>(<any>null);
    }
    ...
    //  * @return Success
    //  */
    getDetailAsync(id: number): Observable<ContentDto> {
    ...
    protected processGetDetailAsync(response: HttpResponseBase): Observable<ContentDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    //  * @return Success
    //  */
    createUpdateAsync(input: CreateContentDto): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/CMSService/InsertOrUpdateCSMContent";
        url_ = url_.replace(/[?&]$/, "");
...
export class ListResultDtoOfContentListDto implements IListResultDtoOfContentListDto {
  items: ContentListDto[];

  constructor(data?: IListResultDtoOfContentListDto) {
      if (data) {
          for (var property in data) {
              if (data.hasOwnProperty(property))
                  (<any>this)[property] = (<any>data)[property];
  ...
  init(data?: any) {
      if (data) {
          if (data["items"] && data["items"].constructor === Array) {
              this.items = [] as any;
              for (let item of data["items"])
                  this.items.push(ContentListDto.fromJS(item));
          }
      }
  }

  static fromJS(data: any): ListResultDtoOfContentListDto {
      data = typeof data === 'object' ? data : {};
      let result = new ListResultDtoOfContentListDto();
      result.init(data);
      return result;
  }
  ...
  clone(): ListResultDtoOfContentListDto {
      const json = this.toJSON();
      let result = new ListResultDtoOfContentListDto();
      result.init(json);
      return result;
...
export interface IListResultDtoOfContentListDto {
  items: ContentListDto[];
}

export class ContentListDto implements IContentListDto {
  pageName: string;
  pageContent: string;
  id: string;

  constructor(data?: IContentListDto) {
      if (data) {
          for (var property in data) {
              if (data.hasOwnProperty(property))
                  (<any>this)[property] = (<any>data)[property];
  ...
  static fromJS(data: any): ContentListDto {
      data = typeof data === 'object' ? data : {};
      let result = new ContentListDto();
      result.init(data);
      return result;
  }
...
export interface IContentListDto {
  pageName: string;
  pageContent: string;
  id: string;
}
